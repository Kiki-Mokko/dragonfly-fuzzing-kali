...
5. [Запуск фаззинга](#5-запуск-фаззинга)
...
### 4.4: Подготовка тестовых данных
...
- Для безопасности: Полученные результаты свидетельствуют об отсутствии критических уязвимостей класса memory corruption в тестируемом компоненте.
- Для разработки: Создан ценный корпус тестовых данных (432 тест-кейса), который может быть использован для регрессионного тестирования.
- Для методологии: Подтверждена эффективность использования AFL++ для различных видов тестирования, в том числе и сетевых парсеров и протоколов.
